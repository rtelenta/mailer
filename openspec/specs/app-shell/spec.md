...
Defines the persistent authenticated shell layout that wraps all protected pages — providing a sidebar for navigation, a header for user identity and sign-out, and stub pages for each main section.

...
Defines the foundational infrastructure for the mailer project: database connectivity, migration tooling, API routing via Hono, environment variable management, UI string localization, and the shadcn/ui component library setup.
